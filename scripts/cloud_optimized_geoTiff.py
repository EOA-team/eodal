...
dem_file = 'https://data.geo.admin.ch/ch.swisstopo.swissalti3d/' + \
    'swissalti3d_2019_2618-1092/swissalti3d_2019_2618-1092_2_2056_5728.tif'
...
# ---------.
# Name:    Elevation
# GeoInfo:    {'epsg': 2056, 'ulx': 2618000.0, 'uly': 1093000.0, 'pixres_x': 2.0, 'pixres_y': -2.0}   # noqa: E501

# fast visualization
fig = dem.plot(
    colormap='terrain',
    colorbar_label='Elevation above Mean Sea Level [m]'
)
